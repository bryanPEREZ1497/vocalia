...
export const MADRID: Jugador[] = [
    ...
    { nombre: 'DANNY', camiseta: 19, goles: 0, equipo: 'Madrid' },
    { nombre: 'PEDRO', camiseta: 18, goles: 0, equipo: 'Madrid' },
    { nombre: 'EDGAR', camiseta: 17, goles: 0, equipo: 'Madrid' },
    { nombre: 'MARCO', camiseta: 16, goles: 0, equipo: 'Madrid' },
    { nombre: 'FELIX', camiseta: 15, goles: 0, equipo: 'Madrid' },
    { nombre: 'GABRIEL', camiseta: 14, goles: 0, equipo: 'Madrid' }
]